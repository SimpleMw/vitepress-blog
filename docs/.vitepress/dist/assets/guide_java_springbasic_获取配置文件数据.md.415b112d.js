import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.03c32d59.js";const u=JSON.parse('{"title":"获取配置文件参数","description":"","frontmatter":{"title":"获取配置文件参数","date":"2021-09-22T18:34:36.000Z"},"headers":[],"relativePath":"guide/java/springbasic/获取配置文件数据.md","filePath":"guide/java/springbasic/获取配置文件数据.md"}'),l={name:"guide/java/springbasic/获取配置文件数据.md"},o=p(`<p>依赖</p><div class="language-xml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">xml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">&lt;!-- 该依赖功能为在书写yml时有提示 --&gt;</span></span>
