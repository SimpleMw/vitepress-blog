import{_ as s,o as a,c as n,Q as p}from"./chunks/framework.dd5a1521.js";const A=JSON.parse('{"title":"Mybatis流式查询","description":"","frontmatter":{"title":"Mybatis流式查询","date":"2023-02-13T10:20:27.000Z"},"headers":[],"relativePath":"guide/java/springboot/mybatis/mybatis流式查询.md","filePath":"guide/java/springboot/mybatis/mybatis流式查询.md"}'),l={name:"guide/java/springboot/mybatis/mybatis流式查询.md"},o=p(`<ul><li>使用Mybatis的Cursor</li><li>代码</li></ul><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> org.apache.ibatis.cursor.Cursor;</span></span>
...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div>`,2),e=[o];function t(r,c,E,y,i,m){return a(),n("div",null,e)}const u=s(l,[["render",t]]);export{A as __pageData,u as default};
