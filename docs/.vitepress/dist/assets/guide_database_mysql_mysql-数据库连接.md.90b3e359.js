import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.03c32d59.js";const d=JSON.parse('{"title":"mysql数据库连接","description":"","frontmatter":{"title":"mysql数据库连接","date":"2020-10-14T08:48:16.000Z"},"headers":[],"relativePath":"guide/database/mysql/mysql-数据库连接.md","filePath":"guide/database/mysql/mysql-数据库连接.md"}'),p={name:"guide/database/mysql/mysql-数据库连接.md"},o=l(`<ul><li>数据库连接代码</li></ul><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">public</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">static</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">void</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">main</span><span style="color:#E1E4E8;">(</span><span style="color:#F97583;">String</span><span style="color:#E1E4E8;">[] args) {</span></span>
