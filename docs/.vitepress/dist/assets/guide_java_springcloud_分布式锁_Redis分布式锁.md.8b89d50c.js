import{_ as p,C as o,o as e,c as t,k as n,H as c,w as r,a as s,Q as a}from"./chunks/framework.03c32d59.js";const f=JSON.parse('{"title":"redis分布式锁使用","description":"","frontmatter":{"title":"redis分布式锁使用","date":"2021-04-22T10:20:27.000Z"},"headers":[],"relativePath":"guide/java/springcloud/分布式锁/Redis分布式锁.md","filePath":"guide/java/springcloud/分布式锁/Redis分布式锁.md"}'),E={name:"guide/java/springcloud/分布式锁/Redis分布式锁.md"},y=a(`<h5 id="安装redis" tabindex="-1"><a href="./.html">安装redis</a> <a class="header-anchor" href="#安装redis" aria-label="Permalink to &quot;[安装redis]()&quot;">​</a></h5><h5 id="整合redis" tabindex="-1">整合redis <a class="header-anchor" href="#整合redis" aria-label="Permalink to &quot;整合redis&quot;">​</a></h5><h5 id="简单的原生实现" tabindex="-1">简单的原生实现 <a class="header-anchor" href="#简单的原生实现" aria-label="Permalink to &quot;简单的原生实现&quot;">​</a></h5><ul><li>依赖</li></ul><div class="language-XML vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">XML</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">dependency</span><span style="color:#E1E4E8;">&gt;</span></span>
...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div>`,10);function F(A,g,D,k,C,v){const l=o("font");return e(),t("div",null,[y,n("h5",i,[c(l,{color:"red"},{default:r(()=>[s("redis分布式锁实现原理")]),_:1}),s(),d]),u])}const m=p(E,[["render",F]]);export{f as __pageData,m as default};
