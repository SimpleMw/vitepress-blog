import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.03c32d59.js";const u=JSON.parse('{"title":"flowable新理解","description":"","frontmatter":{"title":"flowable新理解","date":"2023-05-24T18:12:13.000Z"},"headers":[],"relativePath":"guide/springboot/Flowable-new.md","filePath":"guide/springboot/Flowable-new.md"}'),p={name:"guide/springboot/Flowable-new.md"},o=l(`<h4 id="部分" tabindex="-1">部分 <a class="header-anchor" href="#部分" aria-label="Permalink to &quot;部分&quot;">​</a></h4><ul><li>流程</li><li>应用程序</li><li>任务</li></ul><p>注：</p><p>1.创建流程 -&gt; 创建应用程序 -&gt;开启任务 -&gt; 用户任务提交和完成</p><p>2.启动程序的时候会校验是否已经创建表，若不存在则会创建</p><p>3.创建流程的时候不止可以指定单人，也可以指定组</p><p>4.一个流程可以创建多个流程定义</p><h4 id="api相关" tabindex="-1">API相关 <a class="header-anchor" href="#api相关" aria-label="Permalink to &quot;API相关&quot;">​</a></h4><ul><li>ProcessEngine 管理整个流程引擎</li><li>RepositoryService 管理流程定义</li><li>RuntimeService 管理流程实例</li><li>TaskService 管理流程任务</li></ul><h4 id="整合" tabindex="-1">整合 <a class="header-anchor" href="#整合" aria-label="Permalink to &quot;整合&quot;">​</a></h4><ul><li>maven配置</li></ul><div class="language-xml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">xml</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">parent</span><span style="color:#E1E4E8;">&gt;</span></span>
